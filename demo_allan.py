...
motion_def_path = os.path.abspath('.//test-motion_def//')
...
def test_allan():
    ...
    imu_err = {'gyro_b': np.array([0.0, 0.0, 0.0]),
               'gyro_arw': np.array([0.66, 0.66, 0.66]) * 1.0,
               'gyro_b_stability': np.array([14.5, 14.5, 14.5]) * 1.0,
               'gyro_b_corr': np.array([100.0, 100.0, 100.0]),
               'accel_b': np.array([0.0e-3, 0.0e-3, 0.0e-3]),
               'accel_vrw': np.array([0.11, 0.11, 0.11]) * 1.0,
               'accel_b_stability': np.array([2.4525, 2.4525, 2.4525]) * 1.0,
    ...
    sim = ins_sim.Sim([fs, 0.0, 0.0],
                      motion_def_path+"//motion_def-2023-08-08-16-27.csv",
                      ref_frame=1,
                      imu=imu,
                      mode=None,
                      env=None,
