...
motion_def_path = os.path.abspath('/workspaces/gnss-ins-sim/test-motion_def//')
...
def gen_data_first(data_dir):
    ...
    sim = ins_sim.Sim([fs, fs_gps, fs_mag],
                      motion_def_path+"//motion_def-2023-08-16-12-41.csv",
                      #motion_def_path+"//motion_def-0to100_sample_by_sample.csv",
                      ref_frame=0,
                      imu=imu,
                      mode=None,
                      env=None,
...
def test_gen_data_from_files(data_dir):
    ...
    '''
    ini_pos_vel_att = np.genfromtxt(motion_def_path+"//motion_def-2023-08-16-11-29.csv",\
...
if __name__ == '__main__':
    dir_of_logged_files = os.path.abspath('/workspaces/gnss-ins-sim/work/demo_saved_data/tmp//')
